...
bool RP_Output::IsFeasibleRouter (point r)
{
    return (!in.IsWall(r.row, r.col) && (in.RouterPrice() + (ManhattanDistance(r, ClosestBackbonePoint(r)) * in.BackbonePrice()) <= RemainingBudget()));
}
